...
public class LightUI : MonoBehaviour, IEventHandler
{
    ...
    {
        if (e.getGameObject().GetComponent<LightProperties>() != null)
        {
            e.getGameObject().GetComponent<LightProperties>().Display(content);
        }
    }
